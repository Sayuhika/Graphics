...
// Graphics_test.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphics_testApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CGraphics_testApp

CGraphics_testApp::CGraphics_testApp()
{
...
// Единственный объект CGraphics_testApp

CGraphics_testApp theApp;


// инициализация CGraphics_testApp

BOOL CGraphics_testApp::InitInstance()
{
