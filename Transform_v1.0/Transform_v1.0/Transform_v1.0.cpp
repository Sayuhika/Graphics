...
// Transform_v1.0.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTransform_v10App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTransform_v10App

CTransform_v10App::CTransform_v10App()
{
...
// Единственный объект CTransform_v10App

CTransform_v10App theApp;


// инициализация CTransform_v10App

BOOL CTransform_v10App::InitInstance()
{
	AfxOleInit();
